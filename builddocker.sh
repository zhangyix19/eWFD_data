...
docker tag ewfd-data-base:latest ewfd-data:base
docker tag ewfd-data-tor:latest ewfd-data:tor
docker tag ewfd-data-data:latest ewfd-data:data
docker tag ewfd-data-data:latest ewfd-data:dev
